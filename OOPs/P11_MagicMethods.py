...
if __name__ == '__main__':
    ABUSUFIYAN = Employee('ABUSUFIYAN', 'Chaudhary', 1000)
    Jagdish = Employee('Jagdish','Pathak', 2000)
    print(ABUSUFIYAN)                # Full Name: ABUSUFIYAN  (This output because of __str__ method overloading)
    print(Jagdish)              # Full Name: Jagdish Pathak
    print(ABUSUFIYAN + Jagdish)      # 3000 (This output because of __add__ method overloading)
    print(ABUSUFIYAN * Jagdish)      # 2000000 (__mul__)
    print(int(ABUSUFIYAN))           # 1000 (__int__)
    print(int(Jagdish))         # 2000 (__int__)
    print(ABUSUFIYAN==Jagdish)